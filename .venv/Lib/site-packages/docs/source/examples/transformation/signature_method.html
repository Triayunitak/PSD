...
<html lang="en" data-content_root="../../../../../../../" >
  ...
  <head>
    ...
    <title>The Signature Method with Sktime &#8212; PSD</title>
...
<link rel="preload" as="script" href="../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/Lib/site-packages/docs/source/examples/transformation/signature_method';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/executablebooks/jupyter-book/issues/new?title=Issue%20on%20page%20%2F.venv/Lib/site-packages/docs/source/examples/transformation/signature_method.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/.venv/Lib/site-packages/docs/source/examples/transformation/signature_method.ipynb" target="_blank"
...
<p><img alt="signature_visualisation" src=".venv/Lib/site-packages/docs/source/examples/transformation/img/signatures_term_visualisation.png" /></p>
...
<span class="g g-Whitespace">      </span><span class="mi">1</span> <span class="c1"># First build a very simple signature transform module</span>
<span class="ne">----&gt; </span><span class="mi">2</span> <span class="n">signature_transform</span> <span class="o">=</span> <span class="n">SignatureTransformer</span><span class="p">(</span>
<span class="g g-Whitespace">      </span><span class="mi">3</span>     <span class="n">augmentation_list</span><span class="o">=</span><span class="p">(</span><span class="s2">&quot;addtime&quot;</span><span class="p">,),</span>
<span class="g g-Whitespace">      </span><span class="mi">4</span>     <span class="n">window_name</span><span class="o">=</span><span class="s2">&quot;global&quot;</span><span class="p">,</span>
<span class="g g-Whitespace">      </span><span class="mi">5</span>     <span class="n">window_depth</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span>
<span class="g g-Whitespace">      </span><span class="mi">6</span>     <span class="n">window_length</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span>
<span class="g g-Whitespace">      </span><span class="mi">7</span>     <span class="n">window_step</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span>
<span class="g g-Whitespace">      </span><span class="mi">8</span>     <span class="n">rescaling</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span>
<span class="g g-Whitespace">      </span><span class="mi">9</span>     <span class="n">sig_tfm</span><span class="o">=</span><span class="s2">&quot;signature&quot;</span><span class="p">,</span>
<span class="g g-Whitespace">     </span><span class="mi">10</span>     <span class="n">depth</span><span class="o">=</span><span class="mi">3</span><span class="p">,</span>
<span class="g g-Whitespace">     </span><span class="mi">11</span> <span class="p">)</span>
<span class="g g-Whitespace">     </span><span class="mi">13</span> <span class="c1"># The simply transform the stream data</span>
<span class="g g-Whitespace">     </span><span class="mi">14</span> <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Raw data shape is: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">train_x</span><span class="o">.</span><span class="n">shape</span><span class="p">))</span>

<span class="nn">File ~\AppData\Local\Programs\Python\Python312\Lib\site-packages\sktime\transformations\panel\signature_based\_signature_method.py:100,</span> in <span class="ni">SignatureTransformer.__init__</span><span class="nt">(self, augmentation_list, window_name, window_depth, window_length, window_step, rescaling, sig_tfm, depth, backend)</span>
<span class="g g-Whitespace">     </span><span class="mi">97</span> <span class="bp">self</span><span class="o">.</span><span class="n">depth</span> <span class="o">=</span> <span class="n">depth</span>
<span class="g g-Whitespace">     </span><span class="mi">98</span> <span class="bp">self</span><span class="o">.</span><span class="n">backend</span> <span class="o">=</span> <span class="n">backend</span>
<span class="ne">--&gt; </span><span class="mi">100</span> <span class="nb">super</span><span class="p">()</span><span class="o">.</span><span class="fm">__init__</span><span class="p">()</span>
<span class="g g-Whitespace">    </span><span class="mi">102</span> <span class="k">if</span> <span class="n">backend</span> <span class="o">==</span> <span class="s2">&quot;esig&quot;</span><span class="p">:</span>
<span class="g g-Whitespace">    </span><span class="mi">103</span>     <span class="n">_check_soft_dependencies</span><span class="p">(</span><span class="s2">&quot;esig&quot;</span><span class="p">)</span>
...
<span class="nn">File ~\AppData\Local\Programs\Python\Python312\Lib\site-packages\sktime\utils\validation\_dependencies.py:426,</span> in <span class="ni">_check_estimator_deps</span><span class="nt">(obj, msg, severity)</span>
<span class="g g-Whitespace">    </span><span class="mi">423</span>         <span class="n">compatible</span> <span class="o">=</span> <span class="n">compatible</span> <span class="ow">and</span> <span class="n">x_chk</span>
<span class="g g-Whitespace">    </span><span class="mi">424</span>     <span class="k">return</span> <span class="n">compatible</span>
<span class="ne">--&gt; </span><span class="mi">426</span> <span class="n">compatible</span> <span class="o">=</span> <span class="n">compatible</span> <span class="ow">and</span> <span class="n">_check_python_version</span><span class="p">(</span><span class="n">obj</span><span class="p">,</span> <span class="n">severity</span><span class="o">=</span><span class="n">severity</span><span class="p">)</span>
<span class="g g-Whitespace">    </span><span class="mi">428</span> <span class="n">pkg_deps</span> <span class="o">=</span> <span class="n">obj</span><span class="o">.</span><span class="n">get_class_tag</span><span class="p">(</span><span class="s2">&quot;python_dependencies&quot;</span><span class="p">,</span> <span class="kc">None</span><span class="p">)</span>
<span class="g g-Whitespace">    </span><span class="mi">429</span> <span class="n">pck_alias</span> <span class="o">=</span> <span class="n">obj</span><span class="o">.</span><span class="n">get_class_tag</span><span class="p">(</span><span class="s2">&quot;python_dependencies_alias&quot;</span><span class="p">,</span> <span class="kc">None</span><span class="p">)</span>

<span class="nn">File ~\AppData\Local\Programs\Python\Python312\Lib\site-packages\sktime\utils\validation\_dependencies.py:364,</span> in <span class="ni">_check_python_version</span><span class="nt">(obj, package, msg, severity)</span>
<span class="g g-Whitespace">    </span><span class="mi">359</span>         <span class="n">msg</span> <span class="o">+=</span> <span class="p">(</span>
<span class="g g-Whitespace">    </span><span class="mi">360</span>             <span class="sa">f</span><span class="s2">&quot; This is due to python version requirements of the </span><span class="si">{</span><span class="n">package</span><span class="si">}</span><span class="s2"> package.&quot;</span>
<span class="g g-Whitespace">    </span><span class="mi">361</span>         <span class="p">)</span>
<span class="g g-Whitespace">    </span><span class="mi">363</span> <span class="k">if</span> <span class="n">severity</span> <span class="o">==</span> <span class="s2">&quot;error&quot;</span><span class="p">:</span>
<span class="ne">--&gt; </span><span class="mi">364</span>     <span class="k">raise</span> <span class="ne">ModuleNotFoundError</span><span class="p">(</span><span class="n">msg</span><span class="p">)</span>
<span class="g g-Whitespace">    </span><span class="mi">365</span> <span class="k">elif</span> <span class="n">severity</span> <span class="o">==</span> <span class="s2">&quot;warning&quot;</span><span class="p">:</span>
<span class="g g-Whitespace">    </span><span class="mi">366</span>     <span class="n">warnings</span><span class="o">.</span><span class="n">warn</span><span class="p">(</span><span class="n">msg</span><span class="p">,</span> <span class="n">stacklevel</span><span class="o">=</span><span class="mi">2</span><span class="p">)</span>

<span class="ne">ModuleNotFoundError</span>: SignatureTransformer requires python version to be &lt;3.10, but system python version is 3.12.4 (tags/v3.12.4:8e8a4ba, Jun  6 2024, 19:30:16) [MSC v.1940 64 bit (AMD64)].
</pre></div>
</div>
</div>
</div>
...
<p>[3] Lyons, T.J.: Differential equations driven by rough signals. Revista Matem ́atica Iberoamericana14(2), 215–310(1998)</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv\Lib\site-packages\docs\source\examples\transformation"
        },
