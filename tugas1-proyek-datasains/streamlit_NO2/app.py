...
# Load model
model = joblib.load("../models/model_NO2.pkl")
...
if st.button("Prediksi"):
    # Contoh: buat array dummy untuk fitur prediksi
    # Ganti dengan preprocessing asli sesuai model
    X_pred = np.array([i for i in range(n_days)]).reshape(-1, 1)
