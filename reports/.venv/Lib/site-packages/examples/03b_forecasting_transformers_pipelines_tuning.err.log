...
-------------------
['from sklearn.preprocessing import MinMaxScaler, PowerTransformer, RobustScaler', '', 'from sktime.forecasting.compose import TransformedTargetForecaster', 'from sktime.transformations.series.adapt import TabularToSeriesAdaptor', 'from sktime.transformations.series.detrend import Deseasonalizer, Detrender']
...
['    verbose=1,', '    scoring=MeanSquaredError(square_root=True),  # set custom scoring function', ')', 'gscv.fit(y_train)', 'y_pred = gscv.predict(fh=fh)']
-------------------
